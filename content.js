...
function toggleEditor(options) {
	//alert("come from popup");
	var script = document.createElement("script");
	script.setAttribute("type", "text/javascript");
	script.setAttribute("src", chrome.extension.getURL("scripts/inject_editor.js") +
		"#" + ("" + Math.random()).split(".")[1]);
	script.addEventListener("load", function() {
		postMessage(EXT_ID + "::" + JSON.stringify({
			...
			scripts: ["ckeditor/ckeditor.js", "plugins/codemirror/js/codemirror.js",
				"plugins/codemirror/plugin.js", "js/popup.js", "js/jquery.min.js",
				"js/bootstrap.min.js"
			],
			options: options
		}), "*");
